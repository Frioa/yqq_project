...
import com.yqq.lib_image_loader.image.Utils;
 ...
 */
public class ImageLoaderManager1 {

    private ImageLoaderManager1() {
    }

    public static ImageLoaderManager1 getInstance() {
        return SingletonHolder.instance;
    }

    private static class SingletonHolder {
        private static ImageLoaderManager1 instance = new ImageLoaderManager1();
    }
    ...
    private RequestOptions initCommonRequestOption() {
        ...
        RequestOptions priority = options.placeholder(R.mipmap.b4y)
                .error(R.mipmap.b4y)
